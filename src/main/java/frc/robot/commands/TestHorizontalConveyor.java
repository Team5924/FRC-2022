...
public class TestHorizontalConveyor extends CommandBase {
  private final HorizontalConveyorSubsystem m_horizontalConveyor;

  /** Creates a new TestHorizontalConveyor. */
  public TestHorizontalConveyor(HorizontalConveyorSubsystem subsystem) {
    m_horizontalConveyor = subsystem;
