...
public class DoubleBallAuto extends SequentialCommandGroup {
  ...
  public DoubleBallAuto(LimelightSubsystem limelightSubsystem, ShooterSubsystem shooterSubsystem, TurretSubsystem turretSubsystem, VerticalConveyorSubsystem verticalConveyorSubsystem, DriveSubsystem driveSubsystem) {
