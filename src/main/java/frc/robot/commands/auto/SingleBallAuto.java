...
public class SingleBallAuto extends SequentialCommandGroup {
  ...
  public SingleBallAuto(LimelightSubsystem limelightSubsystem, ShooterSubsystem shooterSubsystem, TurretSubsystem turretSubsystem, VerticalConveyorSubsystem verticalConveyorSubsystem, DriveSubsystem driveSubsystem) {
